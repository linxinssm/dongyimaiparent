...
public class GoodsServiceImpl implements GoodsService {
	...
	@Override
	public List<TbItem> findItemsByIdAndStatus(Long[] goodsIds, String status) {

		//当商品审核通过后,查询该商品对应的规格数据,并将启用的规格数据导入到solr中
	...
	public Goods findOne(Long id){
		...
		return new Goods(goodsMapper.selectByPrimaryKey(id),tbGoodsDescMapper.selectByPrimaryKey(id),itemMapper.selectByExample(tbItemExample));
...
//			goodsMapper.deleteByPrimaryKey(id);//真删除
			...
			//当商品删除后,需要将item表中的商品 状态置0,以免删除的商品能够被前台网站查询发生交易
