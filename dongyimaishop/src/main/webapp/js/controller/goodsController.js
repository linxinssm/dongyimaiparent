 //控制层 
app.controller('goodsController' ,function($scope,$location,$controller,typeTemplateService, itemCatService,uploadService ,goodsService){
...
/*=================================以上是矩阵===============================================*/
	...
	$scope.save = function(){
        ...
        //获取文本框的值并赋值给tbGoodsDesc的属性introduction
